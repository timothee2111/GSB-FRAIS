...
/*il manque la table  `LigneFraisForfait`*/
...
('a131', 'Villechalane', 'Louis', 'visiteur', 'azerty', '8 rue des Charmes', '46000', 'Cahors', '2005-12-21'),
...
('f4', 'Gest', 'Alain', 'comptable', 'azerty', '30 avenue de la mer', '13025', 'Berre', '1985-11-01');
-- --------------------------------------------------------
